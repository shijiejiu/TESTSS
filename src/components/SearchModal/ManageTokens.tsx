...
import { Token } from 'swap-supproted-multichain-sdk'
    ...
    <Wrapper>
      <Column style={{ width: '100%', flex: '1 1' }}>
        <PaddedColumn gap="14px">
          ...
          {searchQuery !== '' && !isAddressSearch && <TYPE.error error={true}>输入有效的代币地址</TYPE.error>}
          {searchToken && (
      ...
      <Footer>
        <TYPE.darkGray>提示：自定义代币存储在您的浏览器本地</TYPE.darkGray>
      </Footer>
    </Wrapper>
  )
}
