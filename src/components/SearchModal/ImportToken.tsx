...
import { Token, Currency } from 'swap-supproted-multichain-sdk'
    ...
    <Wrapper>
      <PaddedColumn gap="14px" style={{ width: '100%', flex: '1 1' }}>
        <RowBetween>
          ...
          <TYPE.mediumHeader>导入 {tokens.length > 1 ? 'Tokens' : 'Token'}</TYPE.mediumHeader>
