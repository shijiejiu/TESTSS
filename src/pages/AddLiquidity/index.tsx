...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from 'swap-supproted-multichain-sdk'
          ...
          <TransactionConfirmationModal
            ...
            content={() => (
              <ConfirmationModalContent
                title={noLiquidity ? '您正在创建一个池子' : '您将收到'}
                onDismiss={handleDismissConfirmation}
          ...
          <AutoColumn gap="20px">
              ...
              (isCreate ? (
                ...
                <ColumnCenter>
                  <BlueCard>
                    <AutoColumn gap="10px">
                      <TYPE.link fontWeight={400} color={'primaryText1'}>
                        <b>提示:</b> 当您添加流动性时，您将获得代表您头寸的池子代币。这些代币会自动根据您在池中的份额赚取费用，并且可以随时兑换。
                      </TYPE.link>
                    </AutoColumn>
                  </BlueCard>
                </ColumnCenter>
                ...
                <LightCard padding="0px" borderRadius={'20px'}>
                  <RowBetween padding="1rem">
                    <TYPE.subHeader fontWeight={500} fontSize={14}>
                      {noLiquidity ? 'Initial prices' : 'Prices'} 以及池子份额
                    </TYPE.subHeader>
                  </RowBetween>{' '}
            ...
            {addIsUnsupported ? (
              <ButtonPrimary disabled={true}>
                <TYPE.main mb="4px">不支持的代币</TYPE.main>
              </ButtonPrimary>
            ) : !account ? (
                  ...
                  isValid && (
                    <RowBetween>
                      {approvalA !== ApprovalState.APPROVED && (
                        ...
                        >
                          {approvalA === ApprovalState.PENDING ? (
                            <Dots>正在批准 {currencies[Field.CURRENCY_A]?.symbol}</Dots>
                          ) : (
                      ...
                      {approvalB !== ApprovalState.APPROVED && (
                        ...
                        >
                          {approvalB === ApprovalState.PENDING ? (
                            <Dots>正在批准 {currencies[Field.CURRENCY_B]?.symbol}</Dots>
                          ) : (
