...
import { JSBI, TokenAmount, ETHER, ChainId } from 'swap-supproted-multichain-sdk'
...
export default function Manage({
  ...
  const token = currencyA === ETHER[chainId??ChainId.MAINNET] ? tokenB : tokenA
  const WETH = currencyA === ETHER[chainId??ChainId.MAINNET] ? tokenA : tokenB
