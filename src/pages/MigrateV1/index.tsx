import { ChainId, JSBI, Token } from 'swap-supproted-multichain-sdk'
...
export default function MigrateV1() {
  ...
  const isOnSelectedList = isTokenOnList(selectedTokenListTokens, chainId??ChainId.MAINNET, token ?? undefined)
