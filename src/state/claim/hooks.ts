...
import { TokenAmount, JSBI, ChainId } from 'swap-supproted-multichain-sdk'
// import { TokenAmount, JSBI } from 'swap-supproted-multichain-sdk'
...
function fetchClaim(account: string, chainId: ChainId): Promise<UserClaimData | null> {
  ...
  const key = `${chainId}:${account}`
    ...
    const mockClaimData: UserClaimData = {
      index: 0,
      amount: '0',
      proof: [],
      flags: {
