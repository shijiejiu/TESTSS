...
import { Trade, TokenAmount, CurrencyAmount, ETHER, ChainId } from 'swap-supproted-multichain-sdk'
...
export function useApproveCallbackFromTrade(trade?: Trade, allowedSlippage = 0) {
  ...
  // const tradeIsV1 = false && getTradeVersion(trade) === Version.v1 && console.log("error108")
