...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from 'swap-supproted-multichain-sdk'
...
export function isTokenOnList(defaultTokens: TokenAddressMap, chainId : ChainId, currency?: Currency): boolean {
  ...
  if (currency === ETHER[chainId??ChainId.MAINNET]) return true
