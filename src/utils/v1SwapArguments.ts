...
import { CurrencyAmount, ETHER, SwapParameters, Token, Trade, TradeOptionsDeadline, TradeType } from 'swap-supproted-multichain-sdk'
...
export default function v1SwapArguments(
  ...
  const inputETH = trade.inputAmount.currency === ETHER[trade.route.chainId]
  const outputETH = trade.outputAmount.currency === ETHER[trade.route.chainId]
