...
import {
  ...
  TradeType,
  WETH
} from 'swap-supproted-multichain-sdk'
...
export function useV1Trade(
  ...
  const inputIsETH = inputCurrency === ETHER[chainId??ChainId.MAINNET]
  const outputIsETH = outputCurrency === ETHER[chainId??ChainId.MAINNET]
